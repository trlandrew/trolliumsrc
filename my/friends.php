...
<a class="nav-link rounded-0 active" id="pills-friends-tab" data-toggle="pill" href="#pills-friends"a role="tab" aria-controls="pills-friends" ari-selected="true">Friends</a>
</li>
<li class="nav-item" role="presentation">
...
<a href="/tadah/mp_/https://tadah.rocks/users/${id}/profile">
<img style="max-height: 6rem" class="headshot-bg position-relative rounded-circle border mx-1" data-tadah-thumbnail-id="${id}" data-tadah-thumbnail-type="user-headshot">
...
<a href="/tadah/mp_/https://tadah.rocks/users/${id}/profile"><h4 class="font-weight-bold mb-0">${username}</h4></a>
